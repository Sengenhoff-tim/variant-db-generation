...
process PROTGRAPH {
    ...
    tuple val(meta), path("${prefix}.fasta"), emit: output
    ...
    tuple val("${task.process}"), val('protgraph'), eval("protgraph --version"), topic: versions, emit: versions_protgraph
